        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8">
                ...
                <div class="mb-6 text-center">
                    <a href="<?php echo htmlspecialchars($google_login_url); ?>" class="inline-flex items-center justify-center gap-2 border-2 border-blue-600 hover:bg-blue-50 text-blue-600 font-semibold px-6 py-3 rounded-lg transition">
