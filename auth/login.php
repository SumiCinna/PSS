            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8">
                ...
                <form method="POST" action="" id="loginForm">
                    ...
                    <div class="mt-6">
                        ...
                        <button type="button" class="w-full mt-4 flex items-center justify-center gap-2 border border-gray-300 hover:border-gray-400 bg-white py-3 rounded-lg transition">
